...
function Map({ data = [], viewMode }) {
  ...
  const createStationPopup = useCallback((station, data) => {
  ...
  const displayDataPoints = useCallback((rainfallData) => {
  ...
  }, [getColorForRainfall, createStationPopup]);

  const displayContourLines = useCallback((contourData) => {
  ...
  }, [data, viewMode, clearMarkers, displayDataPoints, displayContourLines]);
